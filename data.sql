...
CREATE TABLE `products` (
                            ...
                            `qty` int NOT NULL,
                            `cost_of_capital` float NOT NULL,
                            `sale_qty` int NOT NULL,
                            `type_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
                            `price` float NOT NULL,
                            `post_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
                            `discount` int DEFAULT NULL,
                            `status` enum('activated','deactivated','out_of_stock','coming_soon') DEFAULT 'activated',
                            `thumbnail` varchar(500) DEFAULT NULL,
                            `created_by` varchar(36) DEFAULT NULL,
                            `updated_by` varchar(36) DEFAULT NULL,
                            `deleted_by` varchar(36) DEFAULT NULL,
